        ...
        tileInfoSets={[
          {
            ...
            infoNode: [
              <>
                <p>
                  This project is fully programmed by me using C# and VRChat's
                  exposed Unity API.
                  <br />
                  The experience has been visited over 450,000 times and is
                  available for anyone who has access to VRChat.
                  <br />
            ...
            infoNode: [
              <>
                <p>
                  ...
                  ) for sharing functionality between different guns and
                  challenges.
                  <br />
          ...
          },
          {
            ...
            infoNode: [
              <>
                <p>
                  The environment and lighting is fully set up and made by me
                  using Unity's baked lighting, baked reflections and occlusion
                  culling.
                  <br />
